...
const ProfileView = ({ profile, profileData, setProfileData, onLogout }) => {
    ...
    const calendarData = Object.entries(userProfile.history || {})
        .filter(([date]) => {
